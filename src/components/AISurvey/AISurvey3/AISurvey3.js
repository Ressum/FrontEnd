        ...
        <form>
            <div className='aisurvey-3'>
                ...
                <div id="ai-survey-subject">
                    ...
                    <label htmlFor="subject-options-2">병원</label>
                    ...
                    <label htmlFor="subject-options-8">예체능</label>
                    ...
                    <label htmlFor="subject-options-10">사회 문제</label>
                    <input id="subject-options-11" type="checkbox" name="subject-options" />
                    <label htmlFor="subject-options-11">돈</label>
